...
from PyQt5.QtWidgets import QWidget, QLabel, QVBoxLayout, QPushButton, QLineEdit, QSizePolicy, QHBoxLayout, QMessageBox

from src.controller.login_controle import LoginUser

class LoginView(QWidget):
    def __init__(self, on_login_success, on_register, width):
        super().__init__()
        ...
        register_btn = QPushButton("Não tem conta? Faça seu cadastro")
    ...
    def toggle_password_visibility(self):
        if self.toggle_button.isChecked():
            ...
            self.toggle_button.setText("🙈")  # Ícone alternativo
        else:
            self.password_input.setEchoMode(QLineEdit.Password)
    ...
    def login(self):
        ...
        response = login_controller.login_user(email, password)
